...
/** Full-page HTML print view for a salary slip rendered from a block-based
 *  template. Owns the print chrome; the document is DocumentRenderer. */
export default function SalarySlipPrintView({
  schema, data,
}: { schema: DocumentSchema; data: SalarySlipDocData }) {
  ...
  return (
    <>
      ...
      <DocumentRenderer schema={schema} sdata={data} />
    </>
  )
}
