...
export function buildContractData(employee: Employee, company: ContractCompany | null, jobDescription = '') {
  ...
  return {
    ...
    'employee.reporting_manager':             emp.reporting_manager,
    'employee.reporting_manager_designation': emp.reporting_manager_designation,
    'employee.employment_country':            emp.employment_country,
    'employee.employment_city':               emp.employment_city,
